...
public:
    HorizontalScroll_dot(char parametr, int value) : parameter_(parametr), value_(value) {}
...
public:
    HorizontalScroll_line(char parametr, int value) : parameter_(parametr), value_(value) {}
...
public:
    HorizontalScroll_fon(char parametr, int value) : parameter_(parametr), value_(value) {}
